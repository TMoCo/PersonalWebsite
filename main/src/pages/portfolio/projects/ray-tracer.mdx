...
<img src="/assets/cornellbox.jpg" alt="The cornell box benchmark scene" style={{width: '80vw'}}/>
...
<em>C++ code for matrix transpose with intrinsics.</em>
</div>
...
<div class="flex-wrapper">
<img src="/assets/midPointBVH.png" style={{"width": "100%;"}}/>
<img src="/assets/horizontalBVH.png" style={{"width": "100%;"}}/>
...
```
<div class="flex-wrapper">
<em>Thread pool initialisation and worker function.</em>
</div>
...
<div class="flex-wrapper">
<img src="/assets/cornellboxtimings.png" style={{"width" :"100%;"}}/>
<em>Cornell box run times (averaging of 4 measurements per sample number) for the cornell box scene.</em>
</div>
...
<div class="flex-wrapper">
<img src="/assets/hmap.jpg" style={{"width": "50%;"}}/>
<img src="/assets/hmap_runtime.jpg" style={{"width": "50%;"}}/>
