...
Despite these challenges, my team achieved a very positive outcome, being able to implement **all the desired features on time** and build a small game scene. The engine was submitted to the 2021 game republic student showcase and won <Link to="https://eps.leeds.ac.uk/computing/news/article/5726/leeds-students-receive-red-kite-game-award-at-the-2021-game-republic-student-showcase
">first prize in the game technology category</Link>.