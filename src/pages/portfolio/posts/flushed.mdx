...
# {meta.title}
I developed Flushed! over half a week with the aim of re-acquainting myself with the Unity game engine's features, which I had last used for my <Link className="link" to={`/portfolio/unity-protein-visualiser`}>undergraduate thesis</Link>
...
I really enjoyed making this little game and it proved to be valuable preparation for making <Link className="link" to={`/portfolio/cant-wait`}>Can't wait</Link>.
